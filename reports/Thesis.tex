...
\begin{abstract}
	...
	RR Lyrae are a type of periodic variable star that are often examined due to their utility as distance indicators in space. An effect known as the Oosterhoff Dichotomy has been seen in populations of RR Lyrae stars in globular clusters in the Milky Way Galaxy. This phenomenon has been argued to suggest that the Milky Way halo was not formed as a result of the accretion of protogalactic fragments as the dwarf spheroidal satellite galaxies of the Milky Way were formed.
...
Firstly I would like to thank my thesis advisors, Shashi Kanbur and Isabelle Bichindaritz. Working on Astronomy research projects under Shashi made my time at Oswego a lot more interesting and presented me with challenges that were very different from the ones I faced in the courses I took. In working on these projects I learned a lot of useful skills that will be sure to remain handy well after graduation. Isabelle Bichindaritz provided helpful guidance in handling the data analysis side of the thesis, in particular in figuring out how to document the data tables that I was working with.

I would also like to greatly thank the entire Computer Science department. In my time here, the classes I have taken in the department have greatly motivated me to work hard and learn more about the things I am interested in.

In taking classes with James Early I learned a lot of the fundamental programming skills I use every day. Professor Early's approach to teaching and full belief in his students' potential to succeed was one of the main motivating factors in my decision to get into Computer Science tutoring and TA'ing. Through Early's classes I was able to improve my communication skills and learn how to work effectively in teams.

In taking classes with Alex Pantaleev I learned a lot about the underlying representations and operations on data in computers. Professor Pantaleev's more hands-off teaching style of providing interesting challenges has helped me to get better at solving problems through hard work and careful research.

In taking classes with Bastian Tenbergen I learned a lot about how to approach software engineering problems. Bastian's focus on teaching the dreaded ``how to work with other software developers and clients'' portion of software engineering helped me to learn a lot about the important soft skills that come in handy in software development and how to make good technical arguments.

In taking classes with David Vampola I was able to broaden my perspective on computer science and see how fields like cognitive science and semiotics share a lot of underlying ideas and approaches with computer science. Vampola's focus on letting students go in their own direction for final projects has helped me to be able to not be afraid to make my own choices when it comes to choosing a research direction to take.

In taking classes with Doug Lea I was able to learn about a wide range of things. DL's open-ended approach to projects helped me to learn to tackle new and unfamiliar problems through hard work and lots of critical thinking. The skills I learned in DL's classes I am sure I will still be making great use of for the rest of my life. The projects I did in DL's classes are among the most interesting things I have had a chance to work on.

I would also like to thank Craig DeLancey and Mark Zelcer. Taking their classes taught me a lot about logical reasoning and argumentation, as well as how to reason in a structured way about complex and occasionally paradoxical concepts.

Lastly I would like to thank my fellow computer science students. My experience here would not have been nearly as remarkable if not for the students I was able to work beside and share this experience with.

\section{Author's Reflections}

My first few semesters in college I had no idea what I wanted to do for my thesis. Beyond my classes I had learned a few different things on the side related to my major, but nothing in particular really jumped out as being a good thesis topic area.

In the Fall of 2016 I took the course CSC 380: Software Engineering with James Early from the Computer Science department. In this course I was able to work with a group of other students on a project related to Astronomy. While working on this project I got to know Shashi Kanbur, the head of the Physics department. After the semester was over I got to work with Shashi on a few different Astronomy research projects over the following semesters.

The various research projects I worked on varied from applying machine learning algorithms to classify periodic variable stars based on light curve data, to using the 3D modeling software Blender to create data visualizations for planetariums, to applying clustering algorithms to RR Lyrae data in relation to the Oosterhoff dichotomy. In working on these research projects I was able to learn a lot about reading Astronomy literature and performing automated data analyses.

Before working on these projects I had not had any experience reading academic papers. Luckily the literature on applications of machine learning for classifying variable stars was fairly inviting and served as a good introduction into the process of reading through academic papers. As I continued working on the projects this skill came in quite in handy and was especially useful for when it came time to write up the thesis.

Before working on these projects I had not done much data analysis before. The most experience with data analysis I think I had was doing some calculations in Microsoft Excel and doing some small ``database-like'' programs for the introductory Computer Science courses. Over the Winter of 2016 I learned a lot about applied machine learning and data analytics for the purposes of classification tasks. This time that I took to learn about data analytics ended up proving very useful over the next few semesters. Additionally learning these skills allowed me to work on a wider set of set of different types of projects, including the research project that ended up becoming my thesis topic.

In working on the research and analysis for my thesis, I learned a lot more about data analysis and I was able to dive more into an academic literature than I had done before. I also learned a lot about reproducibility for data analysis. One of the things that annoyed me most while reading through the literature was a lack of released source code for data analyses, so I wanted to make sure that for my thesis I made all of the source code for the data analysis available and easily runnable. In doing so I learned a lot about how to use makefiles to automate the downloading and processing of data.
